...
// Mutations (navigate, markCard, flipCard) and the close* helpers come from
// the same host so this module stays a thin wire-up over the existing event
// semantics — no behavior change vs. the original inline listener.
