...
- `<link rel="stylesheet" href="styles.css?v=19">` (line 30)

> Cache-bust: every asset URL ends in `?v=19`. Bump the number on release
...
```html
<script defer src="js/data/bbh_vocab.js?v=19"></script>
<script defer src="js/data/bbh_advanced_vocab.js?v=19"></script>
<script defer src="js/data/bbh_reference_data.js?v=19"></script>
<script defer src="js/data/bbh_parsing.js?v=19"></script>
<script defer src="js/data/bbh_grammar.js?v=19"></script>
<script defer src="js/data/bbh_reader.js?v=19"></script>
<script defer src="js/data/bbh_alphabet.js?v=19"></script>
<script defer src="js/logic/pos_logic.js?v=19"></script>
<script defer src="js/pwa/swUpdate.js?v=19"></script>
<script type="module" src="js/app/main.js?v=19"></script>
```
