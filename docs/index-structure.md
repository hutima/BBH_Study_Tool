...
```html
<script defer src="js/data/bbh_vocab.js?v=3"></script>
<script defer src="js/data/bbh_reference_data.js?v=3"></script>
<script defer src="js/data/bbh_parsing.js?v=3"></script>
<script defer src="js/logic/pos_logic.js?v=3"></script>
<script defer src="js/pwa/swUpdate.js?v=3"></script>
<script type="module" src="js/app/main.js?v=3"></script>
```
