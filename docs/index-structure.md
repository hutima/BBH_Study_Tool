...
- `<link rel="stylesheet" href="styles.css?v=21">` (line 30)

> Cache-bust: every asset URL ends in `?v=21`. Bump the number on release
...
```html
<script defer src="js/data/bbh_vocab.js?v=21"></script>
<script defer src="js/data/bbh_advanced_vocab.js?v=21"></script>
<script defer src="js/data/bbh_reference_data.js?v=21"></script>
<script defer src="js/data/bbh_parsing.js?v=21"></script>
<script defer src="js/data/bbh_grammar.js?v=21"></script>
<script defer src="js/data/bbh_reader.js?v=21"></script>
<script defer src="js/data/bbh_alphabet.js?v=21"></script>
<script defer src="js/logic/pos_logic.js?v=21"></script>
<script defer src="js/pwa/swUpdate.js?v=21"></script>
<script type="module" src="js/app/main.js?v=21"></script>
```
...
- **`js/data/bbh_reader.js`** — classic deferred script (Phase 2 PR D),
  ...
  passages}` — 106 curated Reader passages (748 tokens), generated by
