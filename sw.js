...
const CACHE_NAME = 'bbh-flashcards-pwa-v8-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=8',
  'fonts/gentium-plus-latin-400-normal.woff2?v=8',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=8',
  'fonts/gentium-plus-latin-400-italic.woff2?v=8',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=8',
  'fonts/gentium-plus-latin-700-normal.woff2?v=8',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=8',
  'fonts/gentium-plus-latin-700-italic.woff2?v=8',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=8',
  'fonts/noto-sans-latin-normal.woff2?v=8',
  'fonts/noto-sans-latin-ext-normal.woff2?v=8',
  'fonts/noto-sans-latin-italic.woff2?v=8',
  'fonts/noto-sans-latin-ext-italic.woff2?v=8',
  'fonts/noto-serif-hebrew.woff2?v=8',
  'fonts/noto-sans-hebrew.woff2?v=8',
  'manifest.json?v=8',
  'favicon.svg?v=8',
  'js/data/bbh_vocab.js?v=8',
  'js/data/bbh_reference_data.js?v=8',
  'js/data/bbh_parsing.js?v=8',
  'js/data/bbh_grammar.js?v=8',
  'js/data/bbh_reader.js?v=8',
  'js/data/bbh_alphabet.js?v=8',
  'js/data/bbh_reference_extra.js?v=8',
  'js/logic/pos_logic.js?v=8',
  'js/data/setMeta.js?v=8',
  'js/app/main.js?v=8',
  'js/domain/deck/filters.js?v=8',
  'js/domain/deck/ordering.js?v=8',
  'js/domain/parsing/gates.js?v=8',
  'js/domain/parsing/drill.js?v=8',
  'js/domain/gamification/levels.js?v=8',
  'js/domain/gamification/usageStats.js?v=8',
  'js/domain/gamification/xp.js?v=8',
  'js/domain/srs/confidence.js?v=8',
  'js/domain/srs/constants.js?v=8',
  'js/domain/srs/scheduler.js?v=8',
  'js/state/migrations.js?v=8',
  'js/state/persistence.js?v=8',
  'js/state/runtime.js?v=8',
  'js/state/store.js?v=8',
  'js/ui/analytics.js?v=8',
  'js/ui/charts.js?v=8',
  'js/ui/keyboard.js?v=8',
  'js/ui/modals.js?v=8',
  'js/ui/navigation.js?v=8',
  'js/ui/parsing.js?v=8',
  'js/ui/grammar.js?v=8',
  'js/ui/reader.js?v=8',
  'js/ui/alphabet.js?v=8',
  'js/pwa/swUpdate.js?v=8',
  'js/ui/progress.js?v=8',
  'js/ui/pwaInstall.js?v=8',
  'js/ui/render.js?v=8',
  'js/ui/selectors.js?v=8',
  'js/ui/toast.js?v=8',
  'js/ui/touchTapBridge.js?v=8',
  'js/utils/clickShield.js?v=8',
  'js/utils/hebrewText.js?v=8',
  'js/utils/helpers.js?v=8',
  'js/utils/storage.js?v=8',
  'js/utils/time.js?v=8',
