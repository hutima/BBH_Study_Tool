...
const CACHE_NAME = 'bbh-flashcards-pwa-v15-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=15',
  'fonts/gentium-plus-latin-400-normal.woff2?v=15',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=15',
  'fonts/gentium-plus-latin-400-italic.woff2?v=15',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=15',
  'fonts/gentium-plus-latin-700-normal.woff2?v=15',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=15',
  'fonts/gentium-plus-latin-700-italic.woff2?v=15',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=15',
  'fonts/noto-sans-latin-normal.woff2?v=15',
  'fonts/noto-sans-latin-ext-normal.woff2?v=15',
  'fonts/noto-sans-latin-italic.woff2?v=15',
  'fonts/noto-sans-latin-ext-italic.woff2?v=15',
  'fonts/noto-serif-hebrew.woff2?v=15',
  'fonts/noto-sans-hebrew.woff2?v=15',
  'manifest.json?v=15',
  'favicon.svg?v=15',
  'js/data/bbh_vocab.js?v=15',
  'js/data/bbh_book_vocab.js?v=15',
  'js/data/bbh_reference_data.js?v=15',
  'js/data/bbh_parsing.js?v=15',
  'js/data/bbh_grammar.js?v=15',
  'js/data/bbh_reader.js?v=15',
  'js/data/bbh_alphabet.js?v=15',
  'js/data/bbh_reference_extra.js?v=15',
  'js/logic/pos_logic.js?v=15',
  'js/data/setMeta.js?v=15',
  'js/app/main.js?v=15',
  'js/domain/deck/filters.js?v=15',
  'js/domain/deck/ordering.js?v=15',
  'js/domain/parsing/gates.js?v=15',
  'js/domain/parsing/drill.js?v=15',
  'js/domain/gamification/levels.js?v=15',
  'js/domain/gamification/usageStats.js?v=15',
  'js/domain/gamification/xp.js?v=15',
  'js/domain/srs/confidence.js?v=15',
  'js/domain/srs/constants.js?v=15',
  'js/domain/srs/scheduler.js?v=15',
  'js/state/migrations.js?v=15',
  'js/state/persistence.js?v=15',
  'js/state/runtime.js?v=15',
  'js/state/store.js?v=15',
  'js/ui/analytics.js?v=15',
  'js/ui/charts.js?v=15',
  'js/ui/keyboard.js?v=15',
  'js/ui/modals.js?v=15',
  'js/ui/navigation.js?v=15',
  'js/ui/parsing.js?v=15',
  'js/ui/grammar.js?v=15',
  'js/ui/reader.js?v=15',
  'js/ui/alphabet.js?v=15',
  'js/pwa/swUpdate.js?v=15',
  'js/ui/progress.js?v=15',
  'js/ui/pwaInstall.js?v=15',
  'js/ui/render.js?v=15',
  'js/ui/selectors.js?v=15',
  'js/ui/toast.js?v=15',
  'js/ui/touchTapBridge.js?v=15',
  'js/utils/clickShield.js?v=15',
  'js/utils/hebrewText.js?v=15',
  'js/utils/helpers.js?v=15',
  'js/utils/storage.js?v=15',
  'js/utils/time.js?v=15',
