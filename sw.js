...
const CACHE_NAME = 'bbh-flashcards-pwa-v1-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=1',
  'fonts/gentium-plus-latin-400-normal.woff2?v=1',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=1',
  'fonts/gentium-plus-latin-400-italic.woff2?v=1',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=1',
  'fonts/gentium-plus-latin-700-normal.woff2?v=1',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=1',
  'fonts/gentium-plus-latin-700-italic.woff2?v=1',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=1',
  'fonts/noto-sans-latin-normal.woff2?v=1',
  'fonts/noto-sans-latin-ext-normal.woff2?v=1',
  'fonts/noto-sans-latin-italic.woff2?v=1',
  'fonts/noto-sans-latin-ext-italic.woff2?v=1',
  'fonts/noto-serif-hebrew.woff2?v=1',
  'fonts/noto-sans-hebrew.woff2?v=1',
  'manifest.json?v=1',
  'favicon.svg?v=1',
  'js/data/bbh_vocab.js?v=1',
  'js/data/bbh_reference_data.js?v=1',
  ...
  'js/ui/pwaInstall.js?v=1',
  'js/ui/render.js?v=1',
  'js/ui/selectors.js?v=1',
  'js/ui/toast.js?v=1',
  'js/ui/touchTapBridge.js?v=1',
  'js/utils/clickShield.js?v=1',
  'js/utils/hebrewText.js?v=1',
