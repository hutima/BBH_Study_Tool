...
const CACHE_NAME = 'bbh-flashcards-pwa-v14-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=14',
  'fonts/gentium-plus-latin-400-normal.woff2?v=14',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=14',
  'fonts/gentium-plus-latin-400-italic.woff2?v=14',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=14',
  'fonts/gentium-plus-latin-700-normal.woff2?v=14',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=14',
  'fonts/gentium-plus-latin-700-italic.woff2?v=14',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=14',
  'fonts/noto-sans-latin-normal.woff2?v=14',
  'fonts/noto-sans-latin-ext-normal.woff2?v=14',
  'fonts/noto-sans-latin-italic.woff2?v=14',
  'fonts/noto-sans-latin-ext-italic.woff2?v=14',
  'fonts/noto-serif-hebrew.woff2?v=14',
  'fonts/noto-sans-hebrew.woff2?v=14',
  'manifest.json?v=14',
  'favicon.svg?v=14',
  'js/data/bbh_vocab.js?v=14',
  'js/data/bbh_book_vocab.js?v=14',
  'js/data/bbh_reference_data.js?v=14',
  'js/data/bbh_parsing.js?v=14',
  'js/data/bbh_grammar.js?v=14',
  'js/data/bbh_reader.js?v=14',
  'js/data/bbh_alphabet.js?v=14',
  'js/data/bbh_reference_extra.js?v=14',
  'js/logic/pos_logic.js?v=14',
  'js/data/setMeta.js?v=14',
  'js/app/main.js?v=14',
  'js/domain/deck/filters.js?v=14',
  'js/domain/deck/ordering.js?v=14',
  'js/domain/parsing/gates.js?v=14',
  'js/domain/parsing/drill.js?v=14',
  'js/domain/gamification/levels.js?v=14',
  'js/domain/gamification/usageStats.js?v=14',
  'js/domain/gamification/xp.js?v=14',
  'js/domain/srs/confidence.js?v=14',
  'js/domain/srs/constants.js?v=14',
  'js/domain/srs/scheduler.js?v=14',
  'js/state/migrations.js?v=14',
  'js/state/persistence.js?v=14',
  'js/state/runtime.js?v=14',
  'js/state/store.js?v=14',
  'js/ui/analytics.js?v=14',
  'js/ui/charts.js?v=14',
  'js/ui/keyboard.js?v=14',
  'js/ui/modals.js?v=14',
  'js/ui/navigation.js?v=14',
  'js/ui/parsing.js?v=14',
  'js/ui/grammar.js?v=14',
  'js/ui/reader.js?v=14',
  'js/ui/alphabet.js?v=14',
  'js/pwa/swUpdate.js?v=14',
  'js/ui/progress.js?v=14',
  'js/ui/pwaInstall.js?v=14',
  'js/ui/render.js?v=14',
  'js/ui/selectors.js?v=14',
  'js/ui/toast.js?v=14',
  'js/ui/touchTapBridge.js?v=14',
  'js/utils/clickShield.js?v=14',
  'js/utils/hebrewText.js?v=14',
  'js/utils/helpers.js?v=14',
  'js/utils/storage.js?v=14',
  'js/utils/time.js?v=14',
