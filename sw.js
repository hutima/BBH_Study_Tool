...
const CACHE_NAME = 'bbh-flashcards-pwa-v5-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=5',
  'fonts/gentium-plus-latin-400-normal.woff2?v=5',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=5',
  'fonts/gentium-plus-latin-400-italic.woff2?v=5',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=5',
  'fonts/gentium-plus-latin-700-normal.woff2?v=5',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=5',
  'fonts/gentium-plus-latin-700-italic.woff2?v=5',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=5',
  'fonts/noto-sans-latin-normal.woff2?v=5',
  'fonts/noto-sans-latin-ext-normal.woff2?v=5',
  'fonts/noto-sans-latin-italic.woff2?v=5',
  'fonts/noto-sans-latin-ext-italic.woff2?v=5',
  'fonts/noto-serif-hebrew.woff2?v=5',
  'fonts/noto-sans-hebrew.woff2?v=5',
  'manifest.json?v=5',
  'favicon.svg?v=5',
  'js/data/bbh_vocab.js?v=5',
  'js/data/bbh_reference_data.js?v=5',
  'js/data/bbh_parsing.js?v=5',
  'js/data/bbh_grammar.js?v=5',
  'js/data/bbh_reader.js?v=5',
  'js/logic/pos_logic.js?v=5',
  'js/data/setMeta.js?v=5',
  'js/app/main.js?v=5',
  'js/domain/deck/filters.js?v=5',
  'js/domain/deck/ordering.js?v=5',
  'js/domain/parsing/gates.js?v=5',
  'js/domain/parsing/drill.js?v=5',
  'js/domain/gamification/levels.js?v=5',
  'js/domain/gamification/usageStats.js?v=5',
  'js/domain/gamification/xp.js?v=5',
  'js/domain/srs/confidence.js?v=5',
  'js/domain/srs/constants.js?v=5',
  'js/domain/srs/scheduler.js?v=5',
  'js/state/migrations.js?v=5',
  'js/state/persistence.js?v=5',
  'js/state/runtime.js?v=5',
  'js/state/store.js?v=5',
  'js/ui/analytics.js?v=5',
  'js/ui/charts.js?v=5',
  'js/ui/keyboard.js?v=5',
  'js/ui/modals.js?v=5',
  'js/ui/navigation.js?v=5',
  'js/ui/parsing.js?v=5',
  'js/ui/grammar.js?v=5',
  'js/ui/reader.js?v=5',
  'js/pwa/swUpdate.js?v=5',
  'js/ui/progress.js?v=5',
  'js/ui/pwaInstall.js?v=5',
  'js/ui/render.js?v=5',
  'js/ui/selectors.js?v=5',
  'js/ui/toast.js?v=5',
  'js/ui/touchTapBridge.js?v=5',
  'js/utils/clickShield.js?v=5',
  'js/utils/hebrewText.js?v=5',
  'js/utils/helpers.js?v=5',
  'js/utils/storage.js?v=5',
  'js/utils/time.js?v=5',
  'icons/icon-192.png',
  'icons/icon-512.png',
