...
const CACHE_NAME = 'bbh-flashcards-pwa-v3-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=3',
  'fonts/gentium-plus-latin-400-normal.woff2?v=3',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=3',
  'fonts/gentium-plus-latin-400-italic.woff2?v=3',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=3',
  'fonts/gentium-plus-latin-700-normal.woff2?v=3',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=3',
  'fonts/gentium-plus-latin-700-italic.woff2?v=3',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=3',
  'fonts/noto-sans-latin-normal.woff2?v=3',
  'fonts/noto-sans-latin-ext-normal.woff2?v=3',
  'fonts/noto-sans-latin-italic.woff2?v=3',
  'fonts/noto-sans-latin-ext-italic.woff2?v=3',
  'fonts/noto-serif-hebrew.woff2?v=3',
  'fonts/noto-sans-hebrew.woff2?v=3',
  'manifest.json?v=3',
  'favicon.svg?v=3',
  'js/data/bbh_vocab.js?v=3',
  'js/data/bbh_reference_data.js?v=3',
  'js/data/bbh_parsing.js?v=3',
  'js/logic/pos_logic.js?v=3',
  'js/data/setMeta.js?v=3',
  'js/app/main.js?v=3',
  'js/domain/deck/filters.js?v=3',
  'js/domain/deck/ordering.js?v=3',
  'js/domain/parsing/gates.js?v=3',
  'js/domain/parsing/drill.js?v=3',
  'js/domain/gamification/levels.js?v=3',
  'js/domain/gamification/usageStats.js?v=3',
  'js/domain/gamification/xp.js?v=3',
  'js/domain/srs/confidence.js?v=3',
  'js/domain/srs/constants.js?v=3',
  'js/domain/srs/scheduler.js?v=3',
  ...
  'js/ui/charts.js?v=3',
  'js/ui/keyboard.js?v=3',
  'js/ui/modals.js?v=3',
  'js/ui/navigation.js?v=3',
  'js/ui/parsing.js?v=3',
  'js/pwa/swUpdate.js?v=3',
  'js/ui/progress.js?v=3',
  'js/ui/pwaInstall.js?v=3',
  'js/ui/render.js?v=3',
  'js/ui/selectors.js?v=3',
  'js/ui/toast.js?v=3',
  'js/ui/touchTapBridge.js?v=3',
  'js/utils/clickShield.js?v=3',
  'js/utils/hebrewText.js?v=3',
  'js/utils/helpers.js?v=3',
  'js/utils/storage.js?v=3',
  'js/utils/time.js?v=3',
  'icons/icon-192.png',
  'icons/icon-512.png',
