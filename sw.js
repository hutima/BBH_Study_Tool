...
const CACHE_NAME = 'bbh-flashcards-pwa-v2-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=2',
  'fonts/gentium-plus-latin-400-normal.woff2?v=2',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=2',
  'fonts/gentium-plus-latin-400-italic.woff2?v=2',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=2',
  'fonts/gentium-plus-latin-700-normal.woff2?v=2',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=2',
  'fonts/gentium-plus-latin-700-italic.woff2?v=2',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=2',
  'fonts/noto-sans-latin-normal.woff2?v=2',
  'fonts/noto-sans-latin-ext-normal.woff2?v=2',
  'fonts/noto-sans-latin-italic.woff2?v=2',
  'fonts/noto-sans-latin-ext-italic.woff2?v=2',
  'fonts/noto-serif-hebrew.woff2?v=2',
  'fonts/noto-sans-hebrew.woff2?v=2',
  'manifest.json?v=2',
  'favicon.svg?v=2',
  'js/data/bbh_vocab.js?v=2',
  'js/data/bbh_reference_data.js?v=2',
  'js/data/bbh_parsing.js?v=2',
  'js/logic/pos_logic.js?v=2',
  'js/data/setMeta.js?v=2',
  'js/app/main.js?v=2',
  'js/domain/deck/filters.js?v=2',
  'js/domain/deck/ordering.js?v=2',
  'js/domain/parsing/gates.js?v=2',
  'js/domain/parsing/drill.js?v=2',
  'js/domain/gamification/levels.js?v=2',
  'js/domain/gamification/usageStats.js?v=2',
  'js/domain/gamification/xp.js?v=2',
  'js/domain/srs/confidence.js?v=2',
  'js/domain/srs/constants.js?v=2',
  'js/domain/srs/scheduler.js?v=2',
  ...
  'js/ui/charts.js?v=2',
  'js/ui/keyboard.js?v=2',
  'js/ui/modals.js?v=2',
  'js/ui/navigation.js?v=2',
  'js/ui/parsing.js?v=2',
  'js/ui/progress.js?v=2',
  'js/ui/pwaInstall.js?v=2',
  'js/ui/render.js?v=2',
  'js/ui/selectors.js?v=2',
  'js/ui/toast.js?v=2',
  'js/ui/touchTapBridge.js?v=2',
  'js/utils/clickShield.js?v=2',
  'js/utils/hebrewText.js?v=2',
  'js/utils/helpers.js?v=2',
  'js/utils/storage.js?v=2',
  'js/utils/time.js?v=2',
  'icons/icon-192.png',
  'icons/icon-512.png',
