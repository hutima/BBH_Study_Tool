...
const CACHE_NAME = 'bbh-flashcards-pwa-v21-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=21',
  'fonts/gentium-plus-latin-400-normal.woff2?v=21',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=21',
  'fonts/gentium-plus-latin-400-italic.woff2?v=21',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=21',
  'fonts/gentium-plus-latin-700-normal.woff2?v=21',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=21',
  'fonts/gentium-plus-latin-700-italic.woff2?v=21',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=21',
  'fonts/noto-sans-latin-normal.woff2?v=21',
  'fonts/noto-sans-latin-ext-normal.woff2?v=21',
  'fonts/noto-sans-latin-italic.woff2?v=21',
  'fonts/noto-sans-latin-ext-italic.woff2?v=21',
  'fonts/noto-serif-hebrew.woff2?v=21',
  'fonts/noto-sans-hebrew.woff2?v=21',
  'manifest.json?v=21',
  'favicon.svg?v=21',
  'js/data/bbh_vocab.js?v=21',
  'js/data/bbh_advanced_vocab.js?v=21',
  'js/data/bbh_reference_data.js?v=21',
  'js/data/bbh_parsing.js?v=21',
  'js/data/bbh_grammar.js?v=21',
  'js/data/bbh_reader.js?v=21',
  'js/data/bbh_alphabet.js?v=21',
  'js/data/bbh_reference_extra.js?v=21',
  'js/logic/pos_logic.js?v=21',
  'js/data/setMeta.js?v=21',
  'js/app/main.js?v=21',
  'js/domain/deck/filters.js?v=21',
  'js/domain/deck/ordering.js?v=21',
  'js/domain/parsing/gates.js?v=21',
  'js/domain/parsing/drill.js?v=21',
  'js/domain/gamification/levels.js?v=21',
  'js/domain/gamification/usageStats.js?v=21',
  'js/domain/gamification/xp.js?v=21',
  'js/domain/srs/confidence.js?v=21',
  'js/domain/srs/constants.js?v=21',
  'js/domain/srs/scheduler.js?v=21',
  'js/state/migrations.js?v=21',
  'js/state/persistence.js?v=21',
  'js/state/runtime.js?v=21',
  'js/state/store.js?v=21',
  'js/ui/analytics.js?v=21',
  'js/ui/charts.js?v=21',
  'js/ui/keyboard.js?v=21',
  'js/ui/modals.js?v=21',
  'js/ui/navigation.js?v=21',
  'js/ui/parsing.js?v=21',
  'js/ui/grammar.js?v=21',
  'js/ui/reader.js?v=21',
  'js/ui/alphabet.js?v=21',
  'js/pwa/swUpdate.js?v=21',
  'js/ui/progress.js?v=21',
  'js/ui/pwaInstall.js?v=21',
  'js/ui/render.js?v=21',
  'js/ui/selectors.js?v=21',
  'js/ui/toast.js?v=21',
  'js/ui/touchTapBridge.js?v=21',
  'js/utils/clickShield.js?v=21',
  'js/utils/hebrewText.js?v=21',
  'js/utils/helpers.js?v=21',
  'js/utils/storage.js?v=21',
  'js/utils/time.js?v=21',
