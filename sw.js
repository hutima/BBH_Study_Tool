// Service worker for the BBH (Beginning Biblical Hebrew) Study Tool PWA.
//
...
const CACHE_NAME = 'bbh-flashcards-pwa-v17-github-pages';
...
const APP_SHELL_PATHS = [
  ...
  'styles.css?v=17',
  'fonts/gentium-plus-latin-400-normal.woff2?v=17',
  'fonts/gentium-plus-latin-ext-400-normal.woff2?v=17',
  'fonts/gentium-plus-latin-400-italic.woff2?v=17',
  'fonts/gentium-plus-latin-ext-400-italic.woff2?v=17',
  'fonts/gentium-plus-latin-700-normal.woff2?v=17',
  'fonts/gentium-plus-latin-ext-700-normal.woff2?v=17',
  'fonts/gentium-plus-latin-700-italic.woff2?v=17',
  'fonts/gentium-plus-latin-ext-700-italic.woff2?v=17',
  'fonts/noto-sans-latin-normal.woff2?v=17',
  'fonts/noto-sans-latin-ext-normal.woff2?v=17',
  'fonts/noto-sans-latin-italic.woff2?v=17',
  'fonts/noto-sans-latin-ext-italic.woff2?v=17',
  'fonts/noto-serif-hebrew.woff2?v=17',
  'fonts/noto-sans-hebrew.woff2?v=17',
  'manifest.json?v=17',
  'favicon.svg?v=17',
  'js/data/bbh_vocab.js?v=17',
  'js/data/bbh_advanced_vocab.js?v=17',
  'js/data/bbh_reference_data.js?v=17',
  'js/data/bbh_parsing.js?v=17',
  'js/data/bbh_grammar.js?v=17',
  'js/data/bbh_reader.js?v=17',
  'js/data/bbh_alphabet.js?v=17',
  'js/data/bbh_reference_extra.js?v=17',
  'js/logic/pos_logic.js?v=17',
  'js/data/setMeta.js?v=17',
  'js/app/main.js?v=17',
  'js/domain/deck/filters.js?v=17',
  'js/domain/deck/ordering.js?v=17',
  'js/domain/parsing/gates.js?v=17',
  'js/domain/parsing/drill.js?v=17',
  'js/domain/gamification/levels.js?v=17',
  'js/domain/gamification/usageStats.js?v=17',
  'js/domain/gamification/xp.js?v=17',
  'js/domain/srs/confidence.js?v=17',
  'js/domain/srs/constants.js?v=17',
  'js/domain/srs/scheduler.js?v=17',
  'js/state/migrations.js?v=17',
  'js/state/persistence.js?v=17',
  'js/state/runtime.js?v=17',
  'js/state/store.js?v=17',
  'js/ui/analytics.js?v=17',
  'js/ui/charts.js?v=17',
  'js/ui/keyboard.js?v=17',
  'js/ui/modals.js?v=17',
  'js/ui/navigation.js?v=17',
  'js/ui/parsing.js?v=17',
  'js/ui/grammar.js?v=17',
  'js/ui/reader.js?v=17',
  'js/ui/alphabet.js?v=17',
  'js/pwa/swUpdate.js?v=17',
  'js/ui/progress.js?v=17',
  'js/ui/pwaInstall.js?v=17',
  'js/ui/render.js?v=17',
  'js/ui/selectors.js?v=17',
  'js/ui/toast.js?v=17',
  'js/ui/touchTapBridge.js?v=17',
  'js/utils/clickShield.js?v=17',
  'js/utils/hebrewText.js?v=17',
  'js/utils/helpers.js?v=17',
  'js/utils/storage.js?v=17',
  'js/utils/time.js?v=17',
...
self.addEventListener('fetch', event => {
  ...
  // `main.js` at a newer `?v=` matched a cached `main.js` from an older
  // `?v=` and served stale JS against fresh HTML. Now: when the URL carries
  // an explicit `?v=N`
